...
public class Database {
    ...
    private List<String> postgreLauseet() {
        ...
        lista.add("CREATE TABLE Keskustelu (id_keskustelu SERIAL PRIMARY KEY, keskustelualue SERIAL REFERENCES Keskustelualue(id_keskustelualue));");
        lista.add("CREATE TABLE Viesti (id_viesti SERIAL PRIMARY KEY, keskustelu SERIAL REFERENCES Keskustelu(id_keskustelu), kayttaja varchar(200), otsikko varchar (200), runko varchar(1000), viestinaika timestamp);");
